...
OUT_PATH = "policy_img_state_stack4_multi_k3.pt"
...
def main():
    ...
    print(f"N={n} | train={len(train_ds)} val={len(val_ds)} | device={device} | stack={STACK} | state_dim={STATE_DIM}")
    ...
    torch.save(
        {"model_state": model.state_dict(), "img_size": IMG_SIZE, "uses_state": True, "stack": STACK, "state_dim": STATE_DIM},
        OUT_PATH
    )
