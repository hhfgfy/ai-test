...
OUT_PATH = "policy_img_state_stack4.pt"
...
class ImitationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        x_img = torch.cat(frames, dim=0)  # (12,H,W)
...
def main():
    ...
    print(f"N={n} | train={len(train_ds)} val={len(val_ds)} | device={device} | stack={STACK}")
    ...
    torch.save(
        {"model_state": model.state_dict(), "img_size": IMG_SIZE, "uses_state": True, "stack": STACK},
        OUT_PATH
    )
